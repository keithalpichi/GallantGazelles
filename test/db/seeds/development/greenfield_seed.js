    ...
    .then(() => {
      ...
      .then(() => {
        return knex('pitches').insert([
          {user_id: 1, name: 'Pitch 1', video: 'AslncyG8whg', website: 'Pitch 1 Website URL', profile: 'Pitch 1 Profile', blurb: 'Pitch 1 Blurb', category_id: '1', investment_status:'TRUE'},
          {user_id: 2, name: 'Pitch 2', video: 'uODxUJ5Jwis', website: 'Pitch 2 Website URL', profile: 'Pitch 2 Profile', blurb: 'Pitch 2 Blurb', category_id: '2', investment_status:'FALSE'}
          ]);
      });
    }).then(()=> {
